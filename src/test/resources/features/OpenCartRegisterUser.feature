...
Feature: User register in OpenCart
  ...
  Scenario: Successful user registration in OpenCart
    Given the user is on the main page of OpenCart at "https://demo.opencart.com/index.php?route=account/logout&language=en-gb"
    When the user navigates to the registration page
    And the user fills out the registration form with the following details:
      | First Name  | Last Name  | Email                  | Password        |
      | Vienna      | Gutierrez  | medicenney3@gmail.com  | 22333418Vian    |
